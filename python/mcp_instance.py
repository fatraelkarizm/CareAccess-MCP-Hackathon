...
mcp = FastMCP("PriorMCP", stateless_http=True, host="0.0.0.0")
...
mcp.tool(name="assessTreatmentAccess", description="Runs the full PriorMCP coverage, prior authorization, cost, alternative, and draft packet workflow.")(assess_treatment_access)
